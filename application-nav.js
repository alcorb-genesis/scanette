(()=>{'use strict';
const routes={'store-partners.html':'departures','team.html':'team','store-settings.html':'settings','index.html':'scan','gestion.html':'receipts','bellecave.html':'catalogue','gestion-demo.html':'demo'};
