...
function section(name){if(!access)return;if(name!=='home'&&!Object.hasOwn(routes,name))name='home';if(current===name&&$('module').firstChild)return;
 ...
 $('sectionNotice').hidden=!['demo','sale','restock','tours','accounting','stats'].includes(name);$('sectionNotice').textContent='Démonstration : les ventes, la comptabilité et les profils ci-dessous sont simulés. Ils ne modifient pas les données réelles du magasin.';
